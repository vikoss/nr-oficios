...
<body>
    ...
    <a href="{{ secure_asset('validacion/'.$email['id']) }}" target="_blank" rel="noopener noreferrer">
        <img src="{{ secure_asset('images/document.png') }}" alt="">
    </a>
    <a href="{{ secure_asset('validacion/'.$email['id']) }}" target="_blank" rel="noopener noreferrer" style="color: #54191b;">
